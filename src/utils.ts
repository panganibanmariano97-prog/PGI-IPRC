...
export const ROLE_PERMISSIONS = {
  [ROLES.ADMINISTRATOR]: [TABS.DASHBOARD, TABS.INVENTORY, TABS.PURCHASE, TABS.TRANSFER, TABS.PRODUCTION, TABS.ISSUANCE, TABS.BYPRODUCTS, TABS.OTHERS, TABS.SETTINGS, TABS.USERS],
  ...
  [ROLES.OPERATION]: [TABS.INVENTORY, TABS.PURCHASE, TABS.TRANSFER, TABS.PRODUCTION, TABS.ISSUANCE, TABS.BYPRODUCTS, TABS.OTHERS]
};
